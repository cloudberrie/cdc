...
public abstract class DbusEvent
{
  ...
  public boolean isInsertEvent=Boolean.FALSE;
  ...
  public abstract boolean isInsertDbEvent();
  
  public void setInsertDbEvent(Boolean isInsertEvent){
	  this.isInsertEvent=isInsertEvent;
  }
}
