...
public class FieldToAvro
{
  ...
  private Map<String,Object> collectionTypeToAvro(FieldInfo fieldInfo, CollectionTypeInfo typeInfo)
  {
    ...
    String meta = buildMetaString(dbFieldName, dbFieldPosition, dbFieldType, null,null);
                                                   ...
                                                   boolean asSchema)
  {
    ...
    String meta = buildMetaString(dbFieldName, dbFieldPosition, dbFieldType, pk,null);
    field.put("meta", meta);
...
//    field.put("java-class", typeInfo.getPrimitiveType().getJavaObjType());
    ...
    String meta = buildMetaString(dbFieldName, dbFieldPosition, dbFieldType, null,typeInfo.getPrimitiveType().getJavaObjType());
    field.put("meta", meta);
  ...
  private String buildMetaString(String dbFieldName, int dbFieldPosition, String dbFieldType, String pk,String javaObjType)
  {
    ...
    if (dbFieldType != null)
    {
      meta.append("dbFieldType=" + dbFieldType + ";java-class="+javaObjType+";");
    }
