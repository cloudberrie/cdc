...
//          {
//            opCode = DbusOpcode.INSERT;
//            if(_log.isDebugEnabled())
//              _log.debug("The event with scn "+ scn +" is INSERT");
//          }
          ...
          _log.error("kishore: type: "+dbUpdate.getOpType());
          ...
          if(dbUpdate.getOpType() == DbUpdateState.DBUpdateImage.OpType.INSERT){
        	  dbusEventInfo.setIsInsertEvent(Boolean.TRUE);
          }
