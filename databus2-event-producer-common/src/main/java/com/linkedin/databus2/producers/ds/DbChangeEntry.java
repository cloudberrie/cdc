...
public class DbChangeEntry {
	...
	private boolean isInsertDBEvent=Boolean.FALSE;
	...
	public boolean isInsertDBEvent() {
		return isInsertDBEvent;
	}

	public void setInsertDBEvent(boolean isInsertDBEvent) {
		this.isInsertDBEvent = isInsertDBEvent;
	}
}
